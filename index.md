...
This study focuses on the detection of handheld weapons, which are the primary weapons used for crimes such as robbery, rape, and shoplifting. Identifying this behavior early can reduce collateral damage. Deep neural networks are effective in object detection, but not when objects are small like handguns. This study compares two state-of-the-art models, YOLOV4 and YOLOv3, for detecting handguns.
...
[View code on Colab](https://colab.research.google.com/drive/1hQO4nOoD6RDxdbz3C1YSiifTsyZjZpYm)

[View published paper](https://ieeexplore.ieee.org/document/9697321)

<img src="images/results.png?raw=true" width="300"/>  <img src="images/test_batch.jpg?raw=true" width="150"/>


### Fault in wafers detection using CNN (Sensory Data)
The inputs of various sensors for different wafers have been provided. In electronics, a wafer (also called a slice or substrate) is a thin slice of semiconductor used for the fabrication of integrated circuits. The goal is to build a machine learning model which predicts whether a wafer needs to be replaced or not(i.e., whether it is working or not) based on the inputs from various sensors. There are two classes: +1 and -1.

[![](https://img.shields.io/badge/Python-white?logo=Python)](#) [![](https://img.shields.io/badge/Jupyter-white?logo=Jupyter)](#) [![](https://img.shields.io/badge/Google-white?logo=Google)](#) [![](https://img.shields.io/badge/sklearn-white?logo=scikit-learn)](#) [![](https://img.shields.io/badge/pandas-white?logo=data:image/png;base64,)](#) [![](https://img.shields.io/badge/NumPy-white?logo=data:image/png;base64,)](#)


<img src="images/fault_in_wafer.png?raw=true"/>
...
### Deep Convolutional Neural Network (CNN) for Tropical Cyclone intensity estimation
...
<img src="images/cyclone.png?raw=true" width="500" /> 
<img src="images/cyclone_1.jpeg?raw=true" width="200"/>
<img src="images/2-grid.jpg?raw=true" width="350" height="267" />

[View project video](https://drive.google.com/file/d/1YKBOGAmxKE71_hIz_q3fqQRBygd7g1zI/view)
 
[View project Documentation](https://drive.google.com/file/d/1s1wX4ZmAxDHuO-1k57WJ1Qzwi652uQux/view)

Note: This project is winner of ISRO SIH2022 problem Statement. The project is a part of SIH 2022 hackathon and its project & dataset are not public yet. we will do it soon.
